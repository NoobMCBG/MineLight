...
class EventListener implements Listener{
    ...
    public function onBreak(BlockBreakEvent $e){
        ...
        if($api->config->get(strtolower($isim)) == "on"){
            ...
            if($o->getInventory()->getItemInHand()->getId() == 745){
                if($o->getInventory()->getItemInHand()->hasEnchantment(18)){
                    $sl = $o->getInventory()->getItemInHand()->getEnchantment(18)->getLevel();
                    $sl = $sl > 1000 ? 1000 : $sl;
                }
            }
            if($o->getInventory()->getItemInHand()->getId() == 257){
                if($o->getInventory()->getItemInHand()->hasEnchantment(18)){
                    $sl = $o->getInventory()->getItemInHand()->getEnchantment(18)->getLevel();
                    $sl = $sl > 1000 ? 1000 : $sl;
                }
            ...
            if($b->getId() == 16){
                $e->setDrops([]);
                $it = Item::get(173,0,isset($sl) ? mt_rand(1,$sl) : 1);
                if($o->getInventory()->canAddItem($it)){
                    $o->getInventory()->addItem($it);                   
                }
                return true;
            ...
            if($b->getId() == 129){
                $e->setDrops([]);
                $it = Item::get(133,0,isset($sl) ? mt_rand(1,$sl) : 1);
                if($o->getInventory()->canAddItem($it)){
                    $o->getInventory()->addItem($it);               
                }
                return true;
